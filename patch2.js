...
if (contactCode.includes(endPart)) {
  contactCode = contactCode.replace(endPart, replacement);
  fs.writeFileSync('src/pages/Contact.tsx', contactCode);
  console.log('patched contact page 2');
} else {
  console.log('could not find end part in contact page');
}
